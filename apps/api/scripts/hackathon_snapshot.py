...
def run_snapshot_seed():
    ...
    try:
        ...
        events_data = [
            ...
            {"source_event_id": "RISK_REDSEA_2026", "title": "Red Sea / Bab el-Mandeb Shipping Disruption", "description": "Threats forcing Cape reroutes for vessels.", "type": "MARITIME / LOGISTICS", "location": "Bab el-Mandeb", "severity": 0.75, "affected_entity_id": "CHK_BAB_EL_MANDEB", "confidence": 0.9},
